...
public class Imgproc {
    ...
    public static void filter2Dp(Mat src, Mat dst, Mat kernel, Filter2DParams params) {
        filter2Dp_0(src.nativeObj, dst.nativeObj, kernel.nativeObj, params.nativeObj);
    }
    ...
    public static Point putText(Mat img, String text, Point org, Scalar color, FontFace fface, int size, int weight, int flags, Range wrap) {
        return new Point(putText_4(img.nativeObj, text, org.x, org.y, color.val[0], color.val[1], color.val[2], color.val[3], fface.nativeObj, size, weight, flags, wrap.start, wrap.end));
    }
    ...
    public static Point putText(Mat img, String text, Point org, Scalar color, FontFace fface, int size, int weight, int flags) {
        return new Point(putText_5(img.nativeObj, text, org.x, org.y, color.val[0], color.val[1], color.val[2], color.val[3], fface.nativeObj, size, weight, flags));
    }
    ...
    public static Point putText(Mat img, String text, Point org, Scalar color, FontFace fface, int size, int weight) {
        return new Point(putText_6(img.nativeObj, text, org.x, org.y, color.val[0], color.val[1], color.val[2], color.val[3], fface.nativeObj, size, weight));
    }
    ...
    public static Point putText(Mat img, String text, Point org, Scalar color, FontFace fface, int size) {
        return new Point(putText_7(img.nativeObj, text, org.x, org.y, color.val[0], color.val[1], color.val[2], color.val[3], fface.nativeObj, size));
    }
