...
public class HOGDescriptor {
    ...
    //
    // C++:   cv::HOGDescriptor::HOGDescriptor(Size _winSize = Size(64, 128), Size _blockSize = Size(16, 16), Size _blockStride = Size(8, 8), Size _cellSize = Size(8, 8), int _nbins = 9, int _derivAperture = 1, double _winSigma = -1, HOGDescriptor_HistogramNormType _histogramNormType = HOGDescriptor::L2Hys, double _L2HysThreshold = 0.2, bool _gammaCorrection = true, int _nlevels = HOGDescriptor::DEFAULT_NLEVELS, bool _signedGradient = false)
    //
    ...
    public HOGDescriptor(Size _winSize, Size _blockSize, Size _blockStride, Size _cellSize) {
        nativeObj = HOGDescriptor_8(_winSize.width, _winSize.height, _blockSize.width, _blockSize.height, _blockStride.width, _blockStride.height, _cellSize.width, _cellSize.height);
    }
    ...
    public HOGDescriptor(Size _winSize, Size _blockSize, Size _blockStride) {
        nativeObj = HOGDescriptor_9(_winSize.width, _winSize.height, _blockSize.width, _blockSize.height, _blockStride.width, _blockStride.height);
    }
    ...
    public HOGDescriptor(Size _winSize, Size _blockSize) {
        nativeObj = HOGDescriptor_10(_winSize.width, _winSize.height, _blockSize.width, _blockSize.height);
    }
    ...
    public HOGDescriptor(Size _winSize) {
        nativeObj = HOGDescriptor_11(_winSize.width, _winSize.height);
    }
    ...
    public HOGDescriptor(String filename) {
        nativeObj = HOGDescriptor_13(filename);
    }
    ...
    private static native long HOGDescriptor_8(double _winSize_width, double _winSize_height, double _blockSize_width, double _blockSize_height, double _blockStride_width, double _blockStride_height, double _cellSize_width, double _cellSize_height);
    private static native long HOGDescriptor_9(double _winSize_width, double _winSize_height, double _blockSize_width, double _blockSize_height, double _blockStride_width, double _blockStride_height);
    private static native long HOGDescriptor_10(double _winSize_width, double _winSize_height, double _blockSize_width, double _blockSize_height);
    private static native long HOGDescriptor_11(double _winSize_width, double _winSize_height);
    private static native long HOGDescriptor_12();

    // C++:   cv::HOGDescriptor::HOGDescriptor(String filename)
    private static native long HOGDescriptor_13(String filename);
